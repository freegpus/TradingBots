...
class frama_bot():
    ...
    def login_tv(self):
        ...
        login_btn = self.driver.find_element_by_xpath('/html/body/div[2]/div[3]/div[1]/div[4]/span[2]/a')
        login_btn.click()
        sleep(1)
    ...
    def buy_eth(self):
        ...
        try:
            ...
            print("USD element is not working!")
        try:
            usd_btn.click()
        except Exception:
        ...
        try: 
            ...
            print("buy btn element isn't working")
        try:
            buy_btn.click()
            sleep(2)
        except Exception:
    ...
    def sell_eth(self):
        ...
        try:
            ...
            print("eth btn element isn't working!")
        try:
            eth_btn.click()
        except Exception:
        ...
        try:
            ...
            print("sell btn element didn't work!")
        try:
            sell_btn.click()
            sleep(2)
        except Exception:
...
while True:
    if (datetime.datetime.now().hour % 12 == 0) or (datetime.datetime.now().hour % 12 == 0 and datetime.datetime.now().minute == 5):
        print("############################")
        sleep(30)
        print(datetime.datetime.now())
        bot.get_tv_data()
